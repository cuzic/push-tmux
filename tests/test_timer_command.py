...
class TestExpandSlashCommandWithDelay:
    ...
    def test_expand_with_delay_argument(self):
        ...
        result = expand_slash_command('/timer delay:30 message:Custom', config, 'device')
...
class TestDelayedExecution:
    ...
    async def test_error_handling(self):
        ...
        with patch('push_tmux.commands.listen.send_to_tmux', side_effect=Exception('tmux error')):
